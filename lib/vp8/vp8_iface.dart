...
int vp8_init(vpx_codec_ctx_t ctx, dynamic? data) {
  vpx_codec_alg_priv priv = vpx_codec_alg_priv();
  ctx.priv = priv;
  priv.temp_pbi = VP8D_COMP();
  return 0;
}

int vp8_decode(dynamic? priv, Uint8List data, int data_sz, dynamic? user_priv, int deadline) {
...
vpx_image_t? vp8_get_frame(dynamic? priv, Iterator iter) {
  if (priv is vpx_codec_alg_priv) {
